...
export default function WorkIndexPage() {
  ...
  const primaryExperienceItems = productionWorkItems.filter(
    (item) =>
      !item.featured &&
      (item.title === "Raindrop" || item.title === "OBG")
  );

  const additionalExperienceItems = productionWorkItems.filter(
    (item) =>
      item.title === "Ledger Investing" || item.title === "Accenture"
  );
      ...
      <main className="mx-auto w-full max-w-6xl">
        ...
        <section>
          <div className="mb-5">
            ...
            <p className="mt-2 text-sm text-white/70 sm:text-base">
              Production and creative experience across shoots, events, and
              supporting roles.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            {/* Standard Production Experience */}
        ...
        <section className="mt-14">
          <div className="mb-5">
            ...
            <p className="mt-2 text-sm text-white/70 sm:text-base">
              Product, analytics, and technical work that has strengthened how I
